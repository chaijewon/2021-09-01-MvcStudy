...
<div class="wrapper row3">
  <main class="container clear"> 
      ...
      <ul class="slides">
        <c:forEach var="vo" items="${cList }" varStatus="s">
           <c:if test="${s.index>=0 && s.index<12 }">
		        <li>
		          <figure><img class="radius-10 btmspace-10" src="${vo.poster }" title="${vo.subject }" style="width:350px;height:185px">
		            <figcaption><a href="../movie/detail.do?mno=${vo.cno }">${vo.title }</a></figcaption>
		          </figure>
		        </li>
	        </c:if>
        </c:forEach> 
    ...
    <h2 class="sectiontitle">인기별 맛집 리스트</h2>
    <!-- ################################################################################################ -->
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
        <c:forEach var="vo" items="${cList }" varStatus="s">
