    ...
    <table class="table">
      <tr>
        <td class="text-center">
          <span class="btn btn-lg btn-success">상황</span> 
          <span class="btn btn-lg btn-info">감성</span> 
          <span class="btn btn-lg btn-primary">스타일</span> 
          <span class="btn btn-lg btn-danger">날씨/계절</span> 
        </td>
      </tr>
    </table>
  </main>
